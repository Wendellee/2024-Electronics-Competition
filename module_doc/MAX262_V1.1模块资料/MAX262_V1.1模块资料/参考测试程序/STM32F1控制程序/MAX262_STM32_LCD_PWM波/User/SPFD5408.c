...
// 当前版本: V1.0.2
// 历史版本: 
// - V1.0.0: (2014-02-07)基本液晶显示：中英文，点线面，图片显示
// - V1.0.1: (2014-02-15)模拟IO和集成FSMC驱动分开
// - V1.0.2: (2014-02-16)头文件中不包含其他头文件
//					 (2014-03-12)把SPFD5408_RS_Set改成	SPFD5408_WR_Start();
...
// 返回参数: 无
// 全局变量: 无
// 调用模块: SPFD5408_Write_Reg (), 	SPFD5408_Set_Cursor();	.   
// 注意事项:
//-----------------------------------------------------------------
void SPFD5408_Set_Window(u16 X_Size,u16 Y_Size)
{
...
void SPFD5408_Clear_Window(u16 Color)
{
	...
	SPFD5408_Set_Window (XSIZE, YSIZE);  			// 设置窗口	 
	SPFD5408_WR_Start();											// 写GRAM
